...
// ------------------------------------------------------------------ //
// tokenizer.cpp - A string tokenizer                                 //
////////////////////////////////////////////////////////////////////////
...
float Tokenizer::get_float()
{
	...
	return (float)atof((char*)token.c_str());
}
...
bool Tokenizer::get_bool()
{
	...
	if (token == _T("no") || token == _T("No") || token == _T("NO"))
		return false;

	if (token == _T("false") || token == _T("False") || token == _T("FALSE"))
		return false;
